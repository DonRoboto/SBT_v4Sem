...
if __name__ == "__main__":
    ...
    #cambiar parametro requiere "free_log_std": True,
    ...
    if args.env_name in ["LunarLanderContinous-v2", "BipedalWalker-v3"]:
        horizon = 1600
    else:
        horizon = 1600
...
# #cols = all_dfs[0]['info/learner/default_policy/curr_kl_coeff']
